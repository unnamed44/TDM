...
*/
	...
	function membersDps(targetId)
	{
		...
		for(var i in party){
			...
			if(NPCs[npcIndex].totalPartyDamage == 0 || battleduration <= 0 || typeof party[i].Targets[targetId] === 'undefined') continue
			cname=party[i].name
